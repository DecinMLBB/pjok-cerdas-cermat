...
function leaderboard(){
 ...
 // HANYA data pemain asli. Data contoh Raka/Fajar/Siti/dll SUDAH DIHAPUS.
 // Peringkat Sepuh adalah entry tetap dan tidak berasal dari database.
...
function finishQuiz(){
 ...
 const result={username:state.user.username,className:state.user.className,avatarIndex:state.user.avatarIndex||1,score:q.score,correct:q.correct,total:q.items.length,xp,createdAt:Date.now(), id:"local-"+Date.now()+"-"+Math.random().toString(36).slice(2)};
