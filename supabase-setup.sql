-- PJOK ARENA — jalankan SEKALI di Supabase SQL Editor jika ingin leaderboard online.
-- Anonymous Sign-Ins juga harus diaktifkan di Authentication > Providers > Anonymous.
